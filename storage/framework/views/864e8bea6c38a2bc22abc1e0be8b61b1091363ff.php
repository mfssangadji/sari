  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <p class="lead">Silahkan upload bukti pembayaran anda untuk Pemesanan Reklame dengan <strong>(Order ID #<?php echo e($pemesanan->kode_pemesanan); ?>)</strong></p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" method="POST" action="<?php echo e(url('riwayat/'.Request::segment(2).'/payment')); ?>" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
<?php /**PATH C:\xampp\htdocs\scripty\sari\resources\views/payment.blade.php ENDPATH**/ ?>