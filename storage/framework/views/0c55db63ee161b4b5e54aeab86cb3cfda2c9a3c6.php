  ...
  <body>
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        ...
        <a class="p-2 text-dark" href="<?php echo e(route('riwayat')); ?>">Riwayat Pemesanan</a>
        ...
        <?php $__currentLoopData = $reklame; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reklame): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
              ...
              <p><?php echo e($reklame->keterangan); ?></p>
              <a href="<?php echo e(url('reklame/'.$reklame->id.'/order')); ?>" class="btn btn-lg btn-block btn-outline-primary">Pesan</a>
            </div>
          </div>
      ...
      <footer class="pt-4 my-md-5 pt-md-5 border-top">
        <div class="row">
          <div class="col-12 col-md">
            <!-- <img class="mb-2" src="<?php echo e(asset('welcome/logo.png')); ?>" alt="" width="24" height="24"> -->
...
<?php /**PATH C:\xampp\htdocs\scripty\sari\resources\views/reklame.blade.php ENDPATH**/ ?>