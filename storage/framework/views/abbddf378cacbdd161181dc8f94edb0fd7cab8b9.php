<aside class="main-sidebar sidebar-dark-primary elevation-4">
         ...
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if(auth()->user()->status == 1): ?>
               <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                     <li class="nav-item has-treeview">
                        <a href="<?php echo e(route('reklame')); ?>" class="nav-link">
                  ...
                  <ul class="nav nav-treeview">
                     <li class="nav-item has-treeview">
                        <a href="<?php echo e(route('titik')); ?>" class="nav-link">
            ...
            <li class="nav-item has-treeview">
               <a href="<?php echo e(route('pemesanan')); ?>" class="nav-link">
   ...
   <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\scripty\sari\resources\views/auths/parts/sidebar.blade.php ENDPATH**/ ?>