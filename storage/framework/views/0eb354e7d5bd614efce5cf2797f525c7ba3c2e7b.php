...
<html lang="en">
  ...
  <body class="bg-light">
    ...
    <div class="container">
      <?php if($message = Session::get('login-success')): ?>
      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <a href="<?php echo e(route('cregister')); ?>" style="color: #000; text-decoration: none;">
                <div>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" method="post" action="<?php echo e(route('plogin')); ?>" novalidate>
            <?php echo csrf_field(); ?>
            <div class="row">
...
<?php /**PATH C:\xampp\htdocs\scripty\sari\resources\views/login.blade.php ENDPATH**/ ?>