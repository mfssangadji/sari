      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <a href="<?php echo e(route('clogin')); ?>" style="color: #000; text-decoration: none;">
                <div>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" method="POST" action="<?php echo e(route('pregister')); ?>" novalidate>
            <?php echo csrf_field(); ?>
            <div class="row">
...
<?php /**PATH C:\xampp\htdocs\scripty\sari\resources\views/register.blade.php ENDPATH**/ ?>